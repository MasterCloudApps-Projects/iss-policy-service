package es.urjc.code.policy.handler;
...
class RestExceptionHandlerTest {
    ...
    void testValidationError() throws Exception {
    	String content = new ObjectMapper().writeValueAsString( new es.urjc.code.policy.handler.TestController.TestFieldValidation());
